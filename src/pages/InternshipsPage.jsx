        ...
        <div className="container-site relative">
          <Reveal>
            ...
            <h1 className="mt-5 font-heading text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
              Professional <span className="text-gradient-orange">Internships</span>
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-base text-navy-200">
              Real-world industrial training programs, hands-on development, and professional experience certificates.
            </p>
          </Reveal>
        </div>
      </section>
