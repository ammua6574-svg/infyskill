        ...
        <div className="container-site relative">
          <Reveal>
            ...
            <h1 className="mt-5 font-heading text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
              Training &amp; <span className="text-gradient-orange">ERP Services</span>
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-base text-navy-200">
              Tailored training paths for colleges, corporate environments, and business solution development.
            </p>
          </Reveal>
        </div>
      </section>

      {/* Services, Company Training, ERP Components */}
      <Services />
      <CompanyTraining />
      <ErpServices />
    </div>
